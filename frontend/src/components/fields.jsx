...
export function Field({ label, value, onChange, type = "text", required, hint, error,
                        placeholder, ...rest }) {
    ...
    <div>
      <div className="relative">
        <input
          ...
          /* The floating label needs placeholder=" " to sit over an empty
             field. Once focused the label has floated up, so the real
             placeholder can show without colliding with it. */
