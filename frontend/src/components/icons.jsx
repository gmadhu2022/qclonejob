...
export const IconUserPlus = (p) => <S {...p}><circle cx="9" cy="8" r="4" /><path d="M2 20c0-4 3.5-6 7-6" /><path d="M17 11v6M14 14h6" /></S>;
export const IconEdit = (p) => <S {...p}><path d="M12 20h9" /><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4z" /></S>;
export const IconClose = (p) => <S {...p}><circle cx="12" cy="12" r="9" /><path d="M15 9l-6 6M9 9l6 6" /></S>;
export const IconRefresh = (p) => <S {...p}><path d="M21 12a9 9 0 1 1-3-6.7" /><path d="M21 4v5h-5" /></S>;
export const IconPrint = (p) => <S {...p}><path d="M6 9V3h12v6" /><rect x="3" y="9" width="18" height="8" rx="2" /><path d="M7 17h10v4H7z" /></S>;
