  ...
  const side = (
    <aside className={`px-7 py-9 ${a.panel} ${a.panelText}`}>
      {s.profile_picture_url
        ? <img src={mediaUrl(s.profile_picture_url)} alt="" className="mb-5 h-20 w-20 rounded-full object-cover ring-2 ring-white/25" />
      ...
      <header className={`px-10 py-8 ${a.panel} ${a.panelText}`}>
        <div className="flex items-end justify-between gap-6">
          <div className="flex items-center gap-4">
            {s.profile_picture_url && <img src={mediaUrl(s.profile_picture_url)} alt="" className="h-16 w-16 rounded-full object-cover ring-2 ring-white/25" />}
            <div>
  ...
  return (
    <Sheet className="px-11 py-10">
      <header className="flex items-center gap-6 border-b border-slate-200 pb-6">
        {s.profile_picture_url
          ? <img src={mediaUrl(s.profile_picture_url)} alt="" className="h-20 w-20 shrink-0 rounded-full object-cover" />
  ...
  return (
    <Sheet className="px-10 py-10">
      <header className={`mb-7 border-b-2 pb-5 text-center ${a.rule}`}>
        {s.profile_picture_url && <img src={mediaUrl(s.profile_picture_url)} alt="" className="mx-auto mb-3 h-20 w-20 rounded-full object-cover" />}
  ...
  return (
    <Sheet className="px-10 py-9">
      <header className={`mb-6 flex items-center gap-5 rounded-xl p-5 ${a.panel} ${a.panelText}`}>
        {s.profile_picture_url
          ? <img src={mediaUrl(s.profile_picture_url)} alt="" className="h-20 w-20 rounded-lg object-cover ring-2 ring-white/25" />
